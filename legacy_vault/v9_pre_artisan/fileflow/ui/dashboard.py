    ...
    def show_staging_preview(self, preview_data: dict):
        ...
        for entity, file_list in preview_data.items():
            ...
            for f in file_list:
                ...
                elif meta.get('ai_reasoning'):
                    sample_summary = meta['ai_reasoning'][:80]
                
                # Break if both category and summary (or reasoning) are found
                if ai_category and sample_summary:
                    break
            
            # If after checking all files, no summary was found, set to default
