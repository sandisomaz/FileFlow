...
class Unpacker:
    ...
    def analyse(self, source: Path, staging_root: Path) -> UnpackReport:
        """
        ...
        sightings = self._walk_tree(source, report)
    ...
    def _walk_tree(self, root: Path, report: UnpackReport) -> List[FileSighting]:
        """
